...
class AjouterInfirmierFrame extends JFrame {
    public AjouterInfirmierFrame() {
        setTitle("Ajouter un Infirmier");
        setSize(400, 400);
        ...
        JLabel labelService = new JLabel("Specialite:");
        ...
        btnAjouter.addActionListener(e -> {
            ...
            String specialite = fieldService.getText();
            ...
            try {
                ...
                String sql = "INSERT INTO infirmiers (nom, prenom, specialite, date_naissance , poste, mot_de_passe, date_debut_service) VALUES (?, ?, ?, ?, ?, ?, ?)";
